...
reg_postfix = '';
%cv_postfix = '.cv_lh'; % ours: .cv_lh
cv_postfix = '.naive_lh'; % baseline: .naive_lh 
...
for fold = 1:5
    ...
    subj_list = strcat(repelem(subj_list, 1, 1), repmat({'.lh'},length(subj_list),1)); % changed repelem(subj_list, 2, 1)
    %subj_list = strcat(repelem(subj_list, 1, 1), repmat({'.rh'},length(subj_list),1)); % changed repelem(subj_list, 2, 1)

    
    % change to *6 if only lh/rh is used
    subj_list2 = circshift(subj_list, (fold - 1) * 6);
    subj_list2 = subj_list2(25:end);
    ...
    %model = ['/home/lyui/mount/nfs/Parcellation/Sulcus/model/naive_200/' num2str(fold) '/ico5_64_dice_rh/checkpoint_latest.pth.tar_SUNet_best.pth.tar'];
    ...
    model = ['/home/lyui/mount/nfs/Parcellation/Sulcus/model/naive_200/' num2str(fold) '/ico5_64_lh/checkpoint_latest.pth.tar_SUNet_best.pth.tar'];
...
[mean(summary(1:6)) mean(summary(7:12)) mean(summary(13:18)) mean(summary(19:24)) mean(summary(25:30))]

%% visualization
i = 10;  % 20 above ave, 6 below ave
subj = dir([subj_list{i}(1:end-3) '/curves/']);
subj = subj(1).folder;
...
write_property('/tmp/lh_baseline.vtk',v,f,struct('pred', pred_refine, 'truth', truth));
disp('D.');

%% test lh and rh

[v, f] = read_vtk('/home/haol/mount/nfs/Parcellation/icosphere_7.vtk');
lh_file = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/features/n002t2.lh.deg0.H.txt';
rh_file = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/features/n002t2.rh.deg0.H.txt';
lh_lab = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n002t2.lh.deg0.parc.txt';
rh_lab = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n002t2.rh.deg0.parc.txt';

lh_file_15 = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/features/n002t2.lh.deg15.H.txt';
rh_file_15 = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/features/n002t2.rh.deg15.H.txt';
lh_lab_15 = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n002t2.lh.deg15.parc.txt';
rh_lab_15 = '/home/haol/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n002t2.rh.deg15.parc.txt';

write_property('/tmp/test.vtk',v,f,struct('feature_lh', load(lh_file), 'feature_rh', load(rh_file), 'lab_lh', load(lh_lab), 'lab_rh', load(rh_lab)));

write_property('/tmp/test15.vtk',v,f,struct('feature_lh', load(lh_file_15), 'feature_rh', load(rh_file_15), 'lab_lh', load(lh_lab_15), 'lab_rh', load(rh_lab_15)));
