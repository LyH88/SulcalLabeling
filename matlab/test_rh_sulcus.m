...
reg_postfix = '';
cv_postfix = '.cv_rh'; % grey: .cv_rh_2 white: .cv_rh_2_white
disp('done');
...
for fold = 1:5
    ...
    %% likelihood
    parfor i = 1: length(subj_list2) % changed subj_list2 to subj_list
        subj = dir([subj_list2{i}(1:end-3) '/curves/']);  % changed subj_list2 to subj_list
        subj = subj(1).folder;
        
        [~, fname] = fileparts(fileparts(subj));
        [~, ~, hemi] = fileparts(subj_list2{i});  % changed subj_list2 to subj_list
        hemi = hemi(2:end);
        if strcmp(hemi,'rh')
        ...
        [v, f] = read_vtk([subj '/' tmpsubj '.white.vtk']);
...
[v, f] = read_vtk([subj '/' hemi '.white.vtk']);
write_property('/tmp/before_gcut.vtk',v,f,struct('pred', pred_refine, 'truth', truth));
disp('done.');

%% test lh and rh

[v, f] = read_vtk('/home/lyui/mount/nfs/Parcellation/icosphere_7.vtk');
lh_file = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/features/n088t1.lh.deg0.H.txt';
rh_file = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/features/n088t1.rh.deg0.H.txt';
lh_lab = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n088t1.lh.deg0.parc.txt';
rh_lab = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n088t1.rh.deg0.parc.txt';

lh_file_15 = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/features/n088t1.lh.deg15.H.txt';
rh_file_15 = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/features/n088t1.rh.deg15.H.txt';
lh_lab_15 = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n088t1.lh.deg15.parc.txt';
rh_lab_15 = '/home/lyui/mount/nfs/Parcellation/Sulcus/aug/curv/labels/n088t1.rh.deg15.parc.txt';
