...
for fold = 1:5
    ...
    %
    model = ['/home/lyui/mount/nfs/Parcellation/Sulcus/model/naive/' num2str(fold) '/ico5_64/checkpoint_latest.pth.tar_SUNet_best.pth.tar'];
...
write_property('/tmp/cross_naive.vtk',v,f,struct('pred', pred_refine, 'truth', truth));
