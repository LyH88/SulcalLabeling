...
reg_postfix = '';
cv_postfix = '.naive_white'; % baseline: .naive_white ours: ''
disp('done');
...
for fold = 1:5
    ...
    %
   model = ['/home/lyui/mount/nfs/Parcellation/Sulcus/model/naive_200/' num2str(fold) '/ico5_64/checkpoint_latest.pth.tar_SUNet_best.pth.tar'];
   %model = ['/home/lyui/mount/nfs/Parcellation/Sulcus/model/cv/' num2str(fold) '/ico5_64_dice/checkpoint_latest.pth.tar_SUNet_best.pth.tar'];
...
write_property('/tmp/naive_cv.vtk',v,f,struct('pred', pred_refine, 'truth', truth));
